...
<head>
    ...
    <title>Doctor - Room Assignments</title>
    ...
    <div class="flex h-screen">
        ...
        <aside class="w-64 bg-gray-900 text-white flex flex-col min-h-screen">
            ...
            <nav class="flex-1 p-4">
                <ul>
                    ...
                    <li>
                        <a href="${pageContext.request.contextPath}/doctor?action=rooms" class="flex items-center p-2 bg-gray-700 rounded">
        ...
        <div class="flex-1 flex flex-col">
            ...
            <div class="container mx-auto p-6 flex-1">
                <h1 class="text-3xl font-bold text-gray-800 mb-6">Room Assignments</h1>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <c:forEach var="room" items="${assignedRooms}">
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">${room.patientName}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">${room.checkInDate}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">${room.checkOutDate}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                            ${room.status == 'Confirmed' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'}">
                                            ${room.status}
                                        </span>
                                    </td>
                                </tr>
                            ...
                            <c:if test="${empty assignedRooms}">
                                <tr>
                                    <td colspan="6" class="px-6 py-4 text-center text-sm text-gray-500">No rooms assigned.</td>
                                </tr>
                            </c:if>
                        </tbody>
                    </table>
