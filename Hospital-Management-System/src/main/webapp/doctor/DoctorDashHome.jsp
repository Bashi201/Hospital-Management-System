        ...
        <aside class="w-64 bg-gray-900 text-white flex flex-col min-h-screen sidebar overflow-y-auto">
            ...
            <nav class="flex-1 p-4">
                <ul>
                    ...
                    <li>
                        <a href="${pageContext.request.contextPath}/doctor?action=rooms" class="sidebar-link flex items-center p-3 hover:bg-gray-700 rounded text-white">
            ...
            <div class="container mx-auto p-8 flex-1">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
                    ...
                    <a href="${pageContext.request.contextPath}/doctor?action=rooms" 
                       class="dashboard-card bg-white p-8 rounded-xl shadow-md flex flex-col items-center justify-center h-64">
                        <i class="fas fa-bed text-5xl text-purple-500 mb-4"></i>
                        <h2 class="text-xl font-semibold text-gray-800">Room Assignments</h2>
                        <p class="text-gray-500 mt-2 text-center">Check assigned rooms</p>
                    </a>
                </div>
            </div>
        </div>
