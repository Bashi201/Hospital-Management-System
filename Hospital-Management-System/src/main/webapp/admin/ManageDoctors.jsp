        ...
        <div class="flex-1 flex flex-col">
            ...
            <div class="container mx-auto p-6 flex-1 flex items-center justify-center">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-6xl">
                    <a href="${pageContext.request.contextPath}/admin?action=createDoctor" class="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow flex flex-col items-center justify-center h-64">
                        <i class="fas fa-user-plus text-6xl text-blue-600 mb-4"></i>
                        <h2 class="text-2xl font-semibold text-gray-800">Create Doctor</h2>
                        <p class="text-gray-600 mt-2">Add a new doctor</p>
                    </a>
                    <a href="${pageContext.request.contextPath}/admin?action=viewDoctors" class="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow flex flex-col items-center justify-center h-64">
                        <i class="fas fa-list text-6xl text-blue-600 mb-4"></i>
                        <h2 class="text-2xl font-semibold text-gray-800">View Doctors</h2>
                        <p class="text-gray-600 mt-2">View and search all doctors</p>
                    </a>
                    <a href="${pageContext.request.contextPath}/admin?action=viewDoctors" class="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow flex flex-col items-center justify-center h-64">
                        <i class="fas fa-user-edit text-6xl text-blue-600 mb-4"></i>
                        <h2 class="text-2xl font-semibold text-gray-800">Update Doctor</h2>
                        <p class="text-gray-600 mt-2">Update doctor profiles</p>
                    </a>
                </div>
            </div>
        </div>
