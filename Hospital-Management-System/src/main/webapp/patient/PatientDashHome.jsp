                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full max-w-5xl">
                    ...
                    <a href="${pageContext.request.contextPath}/patient?action=channeling" 
                       class="dashboard-tile bg-white p-8 rounded-xl shadow-md flex flex-col items-center justify-center h-64">
                        <i class="fas fa-calendar-alt text-5xl text-teal-500 mb-4"></i>
                        <h2 class="text-xl font-semibold text-gray-800">Channels</h2>
                        <p class="text-gray-600 text-sm mt-2">Book appointments</p>
                    </a>

                    <!-- Doctors Tile -->
                    <a href="${pageContext.request.contextPath}/patient?action=doctors" 
                       class="dashboard-tile bg-white p-8 rounded-xl shadow-md flex flex-col items-center justify-center h-64">
                        <i class="fas fa-user-md text-5xl text-teal-500 mb-4"></i>
                        <h2 class="text-xl font-semibold text-gray-800">Doctors</h2>
                        <p class="text-gray-600 text-sm mt-2">View doctor profiles</p>
                    </a>
                    ...
                    <a href="${pageContext.request.contextPath}/patient?action=rooms" 
                       class="dashboard-tile bg-white p-8 rounded-xl shadow-md flex flex-col items-center justify-center h-64">
                        ...
                        <p class="text-gray-600 text-sm mt-2">Check room availability</p>
                    </a>
                    ...
                    <a href="${pageContext.request.contextPath}/patient?action=ambulanceDashboard" 
                       class="dashboard-tile bg-white p-8 rounded-xl shadow-md flex flex-col items-center justify-center h-64">
                        ...
                        <p class="text-gray-600 text-sm mt-2">Manage ambulance services</p>
                    </a>
                </div>
            </div>
        </div>
