...
<body class="bg-gray-100 font-sans h-full">
    <div class="flex h-full">
        <!-- Sidebar -->
        <aside class="w-64 bg-gray-900 text-white flex flex-col flex-shrink-0 h-full">
        ...
        <div class="flex-1 flex flex-col">
            ...
            <div class="container mx-auto p-6 flex-1">
                <div class="bg-white p-8 rounded-lg shadow-md">
                    <h2 class="text-2xl font-semibold text-gray-800 mb-6">Your Booked Ambulances</h2>
                    <c:if test="${not empty bookedAmbulances}">
                        <table class="w-full table-auto">
                            <thead>
                                <tr class="bg-gray-200 text-gray-700">
                                    <th class="p-2 text-left">ID</th>
                                    <th class="p-2 text-left">Pickup Location</th>
                                    <th class="p-2 text-left">Destination</th>
                                    <th class="p-2 text-left">Request Date</th>
                                    <th class="p-2 text-left">Request Time</th>
                            ...
                            <tbody>
                                <c:forEach var="booking" items="${bookedAmbulances}">
                                    <tr class="border-b">
                                        ...
                                        <td class="p-2">${booking.pickupLocation}</td>
                                        <td class="p-2">${booking.destination}</td>
                                        <td class="p-2">${booking.requestDate}</td>
                                        <td class="p-2">${booking.requestTime}</td>
                    ...
                    <c:if test="${empty bookedAmbulances}">
                        <p class="text-gray-600">You have no booked ambulances.</p>
                    </c:if>
