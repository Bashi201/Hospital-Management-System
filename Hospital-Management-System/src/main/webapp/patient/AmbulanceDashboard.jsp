                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl">
                    ...
                    <a href="${pageContext.request.contextPath}/patient?action=bookAmbulanceForm" 
                       class="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow cursor-pointer flex flex-col items-center justify-center h-64">
                        ...
                        <h2 class="text-2xl font-semibold text-gray-800">Book an Ambulance</h2>
                        <p class="text-gray-600 mt-2">Request a new ambulance service</p>
                    </a>

                    <!-- View Booked Ambulances Tile -->
                    <a href="${pageContext.request.contextPath}/patient?action=viewBookedAmbulances" 
                       class="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow cursor-pointer flex flex-col items-center justify-center h-64">
                        <i class="fas fa-list-alt text-6xl text-blue-600 mb-4"></i>
                        <h2 class="text-2xl font-semibold text-gray-800">Booked Ambulances</h2>
                        <p class="text-gray-600 mt-2">View your ambulance bookings</p>
                    </a>
                </div>
            </div>
        </div>
