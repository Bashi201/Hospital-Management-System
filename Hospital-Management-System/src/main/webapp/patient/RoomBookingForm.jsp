                ...
                <div class="bg-white p-8 rounded-lg shadow-md max-w-2xl mx-auto">
                    ...
                    <form action="${pageContext.request.contextPath}/patient" method="post" class="space-y-6">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <select id="roomType" name="roomType" class="w-2/3 p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        ...
                        <div class="flex items-center space-x-4">
                            <label for="checkOutDate" class="w-1/3 text-gray-700 font-medium">
                                <i class="fas fa-calendar-alt mr-2"></i> Check-Out Date
                            </label>
